 ...
 */
    ...
    */
    ...
    export function motorPowerAssign(motor: gigglebotWhichMotor, power: number) {
        let leftSpeed = Math.abs(power) * 10
        let rightSpeed = Math.abs(power) * 10
        let L1 = 0
        let L2 = 0
        let R1 = 0
        let R2 = 0
        ...
        pins.analogWritePin(AnalogPin.P1, leftSpeed)
        pins.digitalWritePin(DigitalPin.P13, L1)
        pins.digitalWritePin(DigitalPin.P12, L2)
        pins.analogWritePin(AnalogPin.P2, rightSpeed)
        pins.digitalWritePin(DigitalPin.P15, R1)
        pins.digitalWritePin(DigitalPin.P16, R2)
    }
    ...
    export function motorPowerAssignBoth(left_power: number, right_power: number) {
        let leftSpeed = Math.abs(left_power) * 10
        let rightSpeed = Math.abs(right_power) * 10
        let L1 = 0
        let L2 = 0
        let R1 = 0
        let R2 = 0
